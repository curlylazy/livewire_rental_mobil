...
<div>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
        <div class="flex items-center gap-2">
            <flux:button href="{{ url('/') }}" icon="arrow-left" variant="outline" wire:navigate></flux:button>
            <flux:button href='{{ url("/$pageName/add") }}' icon="plus" variant="primary" wire:navigate>Tambah</flux:button>
        </div>
...
<script>
    ...
    $wire.on('edit', (e) => {
        Livewire.navigate(`/${$wire.pageName}/edit/${$wire.selectedKode}`);
    });
